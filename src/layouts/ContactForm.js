      ...
      <div className='page-content pb-0'>
        <div className='container'>
                  ...
                  <div className='contact-info'>
                    ...
                    <ul className='contact-list'>
                      ...
                      <li>
                        ...
                        <a to='tel:#'>+92 423 567</a>
                      </li>
                      <li>
                        <i className='icon-envelope'></i>
                        <a to='mailto:#'>info@Molla.com</a>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className='stores mb-4 mb-lg-5'>
            <h2 className='title text-center mb-3'>Our Offices</h2>
                  ...
                  <div className='row'>
                    <div className='col-sm-5 col-xl-6'>
                      <figure className='store-media mb-2 mb-lg-0'>
                        <img src='assets/images/stores/img-1.jpg' alt='' />
                      </figure>
                    </div>
                    <div className='col-sm-7 col-xl-6'>
                      <div className='store-content'>
                        ...
                        <a to='#' className='btn btn-link' target='_blank'>
                          <span>View Map</span>
                          <i className='icon-long-arrow-right'></i>
                        </a>
                      </div>
